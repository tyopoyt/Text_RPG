...
public class TheLumberingOgre extends Character{
  ...
  private static final Item BROKEN_OGRE_SWORD = new Sword(30,15, 0, 80, "a weapon dropped by The Lumbering Ogre, it shattered when he dropped it, but its still scary!", "Broken Ogre Sword");
