...
public class TestingDriver {
  public static void main(String[] args) {
    ...
    BeginningRoom beginningTortureRoom = new BeginningRoom("You jolt awake, as if you had " +
            ...
            " and overgrown but under the vines you see that they are made of chiseled stone. Above you " +
            ...
            " to the hard, wooden planked, ground. Thankfully, you don't sustain any serious injuries and" +
            ...
            " You place the torch in a wall mount and turn to face the door in front of you, it is metal. You slam" +
